...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='custom_infos_train_lidar.pkl',  # specify your training pkl info
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(pts=''),
        ann_file='custom_infos_val_lidar.pkl',  # specify your validation pkl info
...
val_evaluator = dict(
    type='KittiMetric',
    ann_file=data_root + 'custom_infos_val_lidar.pkl',  # specify your validation pkl info
    metric='bbox')
visualizer = dict(
    name='visualizer',
