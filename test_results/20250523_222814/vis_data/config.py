...
db_sampler = dict(
    ...
    prepare=dict(
        ...
        filter_by_min_points=dict(blue_cone=0, orange_cone=0, yellow_cone=0)),
    rate=1.0,
    sample_groups=dict(blue_cone=2, orange_cone=2, yellow_cone=2))
default_hooks = dict(
...
launcher = 'none'
load_from = '.\\work_dirs\\pointpillars_hv_secfpn_8xb6-160e_kitti-3d-3class\\epoch_20.pth'
log_level = 'INFO'
